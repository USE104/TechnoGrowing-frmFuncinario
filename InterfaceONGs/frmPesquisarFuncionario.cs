    ...
    public partial class frmPesquisarFuncionario : Form
    {
        ...
        public void pesquisaPorRegistro()
        {
            ...
            try
            {
                ...
                lstInformacoes.Items.Add(dr.GetString(4));
                lstInformacoes.Items.Add(dr.GetString(0));
                lstInformacoes.Items.Add(dr.GetString(1));
                lstInformacoes.Items.Add(dr.GetString(2));
                lstInformacoes.Items.Add(dr.GetString(3));
                lstInformacoes.Items.Add(dr.GetString(5));
                lstInformacoes.Items.Add(dr.GetString(6));
                lstInformacoes.Items.Add(dr.GetString(7));
                lstInformacoes.Items.Add(dr.GetString(8));
                lstInformacoes.Items.Add(dr.GetString(9));
                lstInformacoes.Items.Add(dr.GetString(10));
                lstInformacoes.Items.Add(dr.GetString(11));
                lstInformacoes.Items.Add(dr.GetString(12));
                lstInformacoes.Items.Add(dr.GetString(13));
                lstInformacoes.Items.Add(dr.GetString(14));
                lstInformacoes.Items.Add(dr.GetString(15));
        ...
        {
            MySqlCommand comm = new MySqlCommand();
            comm.CommandText = "select nome from tbFuncionario where nome like '%"+txtDescricao.Text+"%';";
            comm.CommandType = CommandType.Text;
            comm.Connection = Conexao.obterConexao();
